...
3.4 Company may monitor, collect, analyze, and store User's usage patterns, inputs, interactions, and all data related to the Service for operational purposes, including providing customer support, improving the Service, conducting analytics, and ensuring compliance with these Terms. Company will not sell, rent, or distribute User data to third parties. Company will not use User Content to train machine learning or artificial intelligence models without User's prior opt-in consent.
3.5 Grant applications, fundraising documents, and other outputs generated through the Service are owned by User upon creation. User may claim full copyright ownership of Service-generated content. Notwithstanding User's ownership, Company retains a limited license to use such outputs in anonymized and aggregated form for the purpose of improving the Service, subject to the anonymization requirements in Section 21A.2. Company will not use identifiable User outputs to train models without User's prior opt-in consent.
...
6.3 Post-termination, User shall not use any proprietary information, trade secrets, algorithms, or confidential materials obtained through the Service to develop, create, or assist in creating any product or service that replicates or substantially imitates the Service's core functionality.
6.4 Upon termination, User shall immediately cease all use of the Service. User retains ownership of all outputs previously generated through the Service in accordance with Section 3.2. User shall delete or return any Company confidential information or proprietary materials upon Company's request.
...
7.1 During the term of this Agreement and for two (2) years thereafter, User shall not, directly or indirectly: (a) Use any proprietary information, trade secrets, algorithms, methodologies, or confidential materials obtained through the Service to develop, create, or assist in creating any product or service that replicates or substantially imitates the Service; (b) Reverse engineer, decompile, or otherwise attempt to derive the source code or underlying technology of the Service; (c) Solicit or hire any employee or contractor of Company for the purpose of developing a competing product or service.
7.2 For clarity, this section does not prohibit User from using other grant writing products or services, or from working in the grant writing industry.
7.3 User acknowledges that this provision is reasonable in scope and duration, and is necessary to protect Company's intellectual property and trade secrets.
8. INDEMNIFICATION
...
21A.1 User Content License. By submitting any content, including but not limited to grant applications, questions, narratives, templates, or related documents (collectively, "User Content") to the Service, User grants Company a non-exclusive, worldwide, royalty-free license to collect, store, and process such content as necessary to provide, operate, and improve the Service. Company may use anonymized and aggregated User Content to improve the Service and facilitate network benefits to other users, subject to the anonymization requirements in Section 21A.2. Company will not use identifiable User Content to train machine learning or artificial intelligence models without User's prior opt-in consent. Company will not sell, rent, or distribute User Content to third parties.
